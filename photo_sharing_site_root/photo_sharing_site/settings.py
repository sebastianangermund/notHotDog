...
SECRET_KEY = '+q*aqruebcd^@t6if6$j)t_m(rfgy85)ic1yka%r$0oo$=m!1!'
...
LOCAL_APPS = [
    'photo_sharing_site.photos.apps.PhotosConfig',
    'photo_sharing_site.api.apps.ApiConfig',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': ['photo_sharing_site/templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
ADMINS = [
    ('Sebastian', 'sebastian@trell.se'),
]

SERVER_EMAIL = 'sebastian@trell.se'
